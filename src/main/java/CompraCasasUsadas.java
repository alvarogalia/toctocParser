...
public class CompraCasasUsadas extends Thread {
    public void run() {
        try (BufferedReader br = new BufferedReader(new FileReader("sh\\salida_compra_casas_usadas.json"))) {
            File fout = new File("out/salida_compra_casas_usadas.json");
            File foutcsv = new File("out/salida_compra_casas_usadas.csv");
            File foutError = new File("out/salida_compra_casas_usadas_error.json");
