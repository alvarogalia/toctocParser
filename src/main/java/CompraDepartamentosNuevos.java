...
public class CompraDepartamentosNuevos extends Thread{
    public void run() {
        try (BufferedReader br = new BufferedReader(new FileReader("sh\\salida_compra_departamentos_nuevos.json"))) {
            File fout = new File("salida_compra_departamentos_nuevos.json");
            File foutcsv = new File("salida_compra_departamentos_nuevos.csv");
            File foutError = new File("salida_compra_departamentos_nuevos_error.json");
