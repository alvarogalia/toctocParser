...
public class CompraDepartamentosNuevos extends Thread {
    public void run() {
        try (BufferedReader br = new BufferedReader(new FileReader("sh\\salida_compra_departamentos_nuevos.json"))) {
            File fout = new File("out/salida_compra_departamentos_nuevos.json");
            File foutcsv = new File("out/salida_compra_departamentos_nuevos.csv");
            File foutError = new File("out/salida_compra_departamentos_nuevos_error.json");
                    ...
                    if (status == 200 || status == 201) {
                        ...
                        if (!JSONObject.NULL.equals(jsonProperties.get("Data"))) {
                            ...
                            if (!JSONObject.NULL.equals(Data.get("Propiedad"))) {
                                ...
                                if (!JSONObject.NULL.equals(Propiedad.get("SitioWeb"))) {
                                    UriFicha = Propiedad.getString("SitioWeb");
                                }
